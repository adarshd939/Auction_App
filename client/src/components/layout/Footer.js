        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              place real-time bids, and experience the thrill of competitive bidding 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/create-auction" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Create Auction
                </Link>
              </li>
              <li>
